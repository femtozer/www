...
export class Gradient {
	...
	disconnect() {
		this.scrollObserver &&
			...
			!isTouchDevice() && window.removeEventListener('resize', this.resize),
	...
	init() {
		this.initGradientColors(),
			...
			this.resize(),
			requestAnimationFrame(this.animate),
			!isTouchDevice() && window.addEventListener('resize', this.resize),
			screen.orientation.addEventListener('change', () => {
				orientationChanged().then(this.resize);
			});
	}
	/*
